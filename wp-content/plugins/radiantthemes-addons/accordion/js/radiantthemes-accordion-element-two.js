jQuery(document).ready(function(){
	jQuery(".rt-accordion.element-two").each(function(){
		...
		jQuery(this).find(".rt-accordion-item-title").click(function(){
			jQuery(".rt-accordion.element-two").find(".rt-accordion-item-body").slideUp("500");
			jQuery(".rt-accordion.element-two").find(".rt-accordion-item").removeClass("rt-active");
